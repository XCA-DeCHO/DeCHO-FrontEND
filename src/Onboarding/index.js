...
function Onboarding ({ navigation }) {
    ...
    return(
        ...
        <VStack w='100%' h='100%' background={colors.onboardcolor1} justifyContent={'flex-end'} p={5}>
            ...
            <Text mb={5} color={colors.white} fontWeight={'500'} fontSize={'24'} fontFamily={'JosefinSans-Bold'}>Congratulations!</Text>
            <Text color={colors.white} fontFamily={'JosefinSans-Regular'}>You Just Connected your Wallet</Text>
        ...
        <VStack w='100%' h='100%' background={colors.onboardcolor2} justifyContent={'flex-end'} p={5}>
            ...
            <Text mb={5} color={colors.white} fontWeight={'500'} fontSize={'24'} fontFamily={'JosefinSans-Bold'}>Now, you can vote and approve projects!</Text>
            <Text color={colors.white} fontFamily={'JosefinSans-Regular'}>Only Approved projects will be listed</Text>
        ...
        <VStack w='100%' h='100%' background={colors.onboardcolor3} justifyContent={'flex-end'} p={5}>
            ...
            <Text mb={5} color={colors.white} fontWeight={'500'} fontSize={'24'} fontFamily={'JosefinSans-Bold'}>View listed projects here.</Text>
            <Text color={colors.white} fontFamily={'JosefinSans-Regular'}>If a project reaches its goal. It will be funded, else all funds will be returned to the donors address.</Text>
            <HStack mt={155} alignSelf={'flex-end'}>
        ...
        <VStack w='100%' h='100%' background={colors.onboardcolor4} justifyContent={'flex-end'} p={5}>
            ...
            <Text mb={5} color={colors.white} fontWeight={'500'} fontSize={'24'} fontFamily={'JosefinSans-Bold'}>Finally, you can earn choice token for performing basic tasks.</Text>
            <Text color={colors.white} fontFamily={'JosefinSans-Regular'}>Ensure, you opt in to the Choice ASA</Text>
            <Pressable onPress={()=>{
                ...
                <Text color={colors.onboardcolor4} fontWeight={'500'} fontSize={'20'} fontFamily={'JosefinSans-Regular'}>Vote!</Text>
            </Pressable>
